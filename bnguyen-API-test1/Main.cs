/***************************************************************
    ...
    *  loss of information.
    *          
    *  To edit the test, open the file ‘bnguyen-API-test1.st’ 
    *  in HP Service Test.
     ***************************************************************/
    ...
    {    
        ...
        internal void InitializeComponent()
        {
            ...
            string xmlDataFetchActivity10Params = @"<Arguments><QueryParametersContainer><QueryParameter><Name>Id</Name><Value>7c2d5ec1-1221-4630-a5a2-208516bdeb4d</Value></QueryParameter><QueryParameter><Name>QueryName</Name><Value>numberFlights</Value></QueryParameter><QueryParameter><Name>IsEmbedded</Name><Value>True</Value></QueryParameter><QueryParameter><Name>Externalized</Name><Value>False</Value></QueryParameter><QueryParameter><Name>GroupText</Name><Value></Value></QueryParameter><QueryParameter><Name>TableStructure</Name><Value>departCity,String,|arriveCity,String,</Value></QueryParameter><QueryParameter><Name>TableContents</Name><Value>London|Paris^London|Denvert^London|Portland</Value></QueryParameter></QueryParametersContainer></Arguments>";
            ...
            _flow.dataSourceNameToDataSource.Add("numberFlights", _flow.DataFetchActivity10);
            ...
            binding_setter20 = new StringFormaterDecorator(binding_setter20,"{Step.DataFetchActivity10.OutTable}");
            bind_dir20 = new BindDirection(_flow.DataFetchActivity10,binding_getter20,binding_setter20,BindTargetType.ToInProperty);
            _flow.DataExporterActivity12.InDirections.Add(bind_dir20);
            ...
            binding_setter21 = new StringFormaterDecorator(binding_setter21,"{Step.DataFetchActivity10.OutTable}");
            bind_dir21 = new BindDirection(_flow.DataFetchActivity10,binding_getter21,binding_setter21,BindTargetType.ToInProperty);
            _flow.DataDisconnectActivity11.InDirections.Add(bind_dir21);
            ...
            VTDPropertyInfoBase pi44 = new VTDPropertyInfoBase("InTable");
            ...
            this.DataCursorActivity14.InDirections.Add(bind_dir22);
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/""><Body><GetFlights xmlns=""HP.SOAQ.SampleApp""><DepartureCity>{DataSource.numberFlights.departCity}</DepartureCity><ArrivalCity>{DataSource.numberFlights.arriveCity}</ArrivalCity><FlightDate>2020-06-26T00:00:00-07:00</FlightDate></GetFlights></Body></Envelope>");
            ...
            VTDPropertyInfoBase pi45 = new VTDPropertyInfoBase("departCity");
            VTDBaseGetter binding_getter23 = new VTDObjectGetter(pi45);
            VTDPropertyInfoBase pi46 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlights'][1]/*[local-name(.)='DepartureCity'][1]");
            VTDBaseSetter binding_setter23 = new VTDXPathSetter(pi46,XmlTypeCode.String);
            binding_setter23 = new StringFormaterDecorator(binding_setter23,"{DataSource.numberFlights.departCity}");
            bind_dir23 = new BindDirection(this.DataCursorActivity14,binding_getter23,binding_setter23,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity8.InDirections.Add(bind_dir23);
            VTDPropertyInfoBase pi47 = new VTDPropertyInfoBase("arriveCity");
            VTDBaseGetter binding_getter24 = new VTDObjectGetter(pi47);
            VTDPropertyInfoBase pi48 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlights'][1]/*[local-name(.)='ArrivalCity'][1]");
            VTDBaseSetter binding_setter24 = new VTDXPathSetter(pi48,XmlTypeCode.String);
            binding_setter24 = new StringFormaterDecorator(binding_setter24,"{DataSource.numberFlights.arriveCity}");
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/"" xmlns:p1=""http://www.w3.org/2001/XMLSchema-instance""><Body><CreateFlightOrder xmlns=""HP.SOAQ.SampleApp""><FlightOrder><Class>Business</Class><CustomerName>bnguyen</CustomerName><DepartureDate>{Step.InputProperties.StServiceCallActivity8.Body.GetFlights.FlightDate}</DepartureDate><FlightNumber>{Step.OutputProperties.StServiceCallActivity8.Body.GetFlightsResponse.GetFlightsResult.Flight[1].FlightNumber}</FlightNumber><NumberOfTickets>2</NumberOfTickets></FlightOrder></CreateFlightOrder></Body></Envelope>");
            ...
            bind_dir25 = new BindDirection(_flow.StServiceCallActivity8,binding_getter25,binding_setter25,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity7.InDirections.Add(bind_dir25);
            ...
            bind_dir26 = new BindDirection(_flow.StServiceCallActivity8,binding_getter26,binding_setter26,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity7.InDirections.Add(bind_dir26);
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/""><Body><CreateFlightOrderResponse xmlns=""HP.SOAQ.SampleApp""><CreateFlightOrderResult><OrderNumber>1</OrderNumber><TotalPrice></TotalPrice></CreateFlightOrderResult></CreateFlightOrderResponse></Body></Envelope>");
